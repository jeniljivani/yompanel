...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="Dashboard.php" class="brand-link">
      ...
      <span class="brand-text font-weight-light">YOM PANEL</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="image/admin/<?php echo @$_SESSION['username']['image'];  ?>" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
          <a href="#" class="d-block"><?php echo @$_SESSION['username']['name'];  ?></a>
        </div>
      </div>
