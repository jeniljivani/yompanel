<?php 
		...
		$p_select ="select * from `posts` where `status`=1 order by `id` desc";
		$p_res = mysqli_query($con,$p_select);
...
<?php 
							$id=0;
							while($post = mysqli_fetch_assoc($p_res))
							{
?>													
							<div class="col-md-4">
								<div style="height: 400px;" class="blog-item">
